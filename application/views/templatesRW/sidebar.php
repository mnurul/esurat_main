            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
               ...
               with font-awesome or any other icon font library -->
                <li class="nav-item has-treeview menu-open">
                    <a class="nav-link active" href="<?php echo base_url('pageRW/index') ?>">
                        <i class="nav-icon fas fa-home"></i>
                        <span class="menu-sidebar" style="font-size: 13px;">Profile Kelurahan<span>
                    </a>
                </li>
                <li class="nav-item has-treeview menu-open">
                    <a class="nav-link active" href="<?php echo base_url('pageRW/surat') ?>">
                        <i class="nav-icon fas fa-mail-bulk"></i>
                        <span class="menu-sidebar" style="font-size: 13px;">Permohonan Surat<span>
                    </a>
                </li>
                <li class="nav-item has-treeview menu-open">
                    <a class="nav-link active" href="<?php echo base_url('pageRW/dataPenduduk') ?>">
