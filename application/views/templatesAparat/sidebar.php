<aside class="main-sidebar sidebar-primary elevation-4" style="background-color: #2F4F4F;">
    <!-- Brand Logo -->
    <a href="<?php echo base_url('pageAparat/index') ?>" class="brand-link ">
            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
               ...
               with font-awesome or any other icon font library -->
                <li class="nav-item has-treeview menu-open">
                    <a class="nav-link active" href="<?php echo base_url('pageAparat/surat') ?>">
                        <i class="nav-icon fas fa-envelope"></i>
                        <span class="menu-sidebar" style="font-size: 13px;">Permohonan Surat<span>
                    </a>
                </li>
                <li class="nav-item has-treeview menu-open">
                    <a class="nav-link active" href="<?php echo base_url('pageAparat/cetakSurat') ?>">
                        <i class="nav-icon fas fa-print"></i>
                        <span class="menu-sidebar" style="font-size: 13px;">Cetak Surat<span>
                    </a>
                </li>
                <li class="nav-item has-treeview menu-open">
