        ...
        <?php foreach ($kk as $s) : ?>
            <div style="display: flex; align-items: center; justify-content: center; gap: 20px;">
                ...
                <div>
                    ...
                    <p style="text-indent: 45px;">Adalah benar seorang kepala keluarga yang berdomisili di Desa MangunJaya, Kecamatan Tambun Selatan, Untuk diketahui bahwa Kartu Keluarga yang bersangkutan saat ini sedang dalam proses pengurusan di Dinas Kependudukan dan Catatan Sipil Kota Bekasi.</p>
                    <p style="text-indent: 45px;">Demikian Surat Keterangan ini dikeluarkan kepada yang bersangkutan untuk dipergunakan sebagaimana mestinya.</p>
                    <div id="ttd">
