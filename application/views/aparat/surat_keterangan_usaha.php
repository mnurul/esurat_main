        ...
        <?php foreach ($usaha as $s) : ?>
            <div style="display: flex; align-items: center; justify-content: center; gap: 20px;">
                ...
                <div>
                    ...
                    <p style="text-indent: 45px;">Adalah benar benar penduduk yang berdomisili di Desa MangunJaya, Kecamatan Tambun Selatan.</p>
                    <p style="text-indent: 45px;">Berdasarkan pengamatan yang telah kami lakukan memang benar yang bersangkutan mempunyai usaha di wilayah Desa MangunJaya.</p>
                    <p style="text-indent: 45px;">Demikian Surat Keterangan Usaha ini dibuat agar dapat dipergunakan
